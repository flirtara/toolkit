...
const randomStringSource = "abcdefghijklmnopqrstuvwxyzABCDEFJGHIJKLMNOPQRSTUVWXYZ0123456789_+"
...
// UploadOneFile is just a convenience method that called UploadFiles, but expects
	...
	for _, fHeaders := range r.MultipartForm.File {
		for _, hdr := range fHeaders {
			uploadedFiles, err = func(uploadedFiles []*UploadedFile) ([]*UploadedFile, error) {
				...
				uploadedFile.OriginFileName = hdr.Filename
				var outfile *os.File
				defer outfile.Close()
